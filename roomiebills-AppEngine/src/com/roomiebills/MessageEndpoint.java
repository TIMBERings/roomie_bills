 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "roomiebills.com", ownerName = "roomiebills.com", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "383200027820.apps.googleusercontent.com";
